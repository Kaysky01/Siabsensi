    ...
    <div class="sesi-list">
      ...
      <div class="sesi-item {{ $sesi->is_active ? 'sesi-active' : 'sesi-inactive' }}">
        ...
        <div class="sesi-actions-compact">
          ...
          <a href="{{ route('admin.absensi-manual.index', $sesi->id) }}" class="action-btn-compact btn-checklist" title="Absensi Manual">
            <span class="material-symbols-outlined">checklist</span>
            <span class="action-label-compact">Absensi</span>
          </a>
          <a href="{{ route('admin.monitoring-sesi', $sesi->id) }}" class="action-btn-compact btn-monitoring" title="Monitoring">
            <span class="material-symbols-outlined">monitoring</span>
            <span class="action-label-compact">Monitor</span>
          </a>
          @endif
          <form method="POST" action="{{ route('admin.kegiatan.toggle', $sesi->id) }}" style="margin:0">
            @csrf
          ...
          <form method="POST" action="{{ route('admin.kegiatan.destroy', $sesi->id) }}" onsubmit="return confirm('Hapus sesi ini dan semua data absensinya?')">
            @csrf @method('DELETE')
    ...
    <div style="display:flex;gap:12px">
      ...
      <div style="flex:1">
        ...
        <ul style="margin:0;padding-left:20px;color:var(--primary-dark);line-height:1.8;font-size:14px">
          ...
          <li>Jadwal PKKMB bisa dikelola di menu <a href="{{ route('admin.pkkmb-schedule.index') }}" style="color:var(--primary-dark);text-decoration:underline;font-weight:600">Jadwal Absensi</a></li>
        </ul>
      </div>
    </div>
  </div>
...
<div class="modal-backdrop" id="modal-add-sesi">
  <div class="modal modal-large">
    ...
    <form method="POST" action="{{ route('admin.kegiatan.store') }}" id="form-add-sesi">
      @csrf
