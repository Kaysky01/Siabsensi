      ...
      <div style="margin-bottom: 24px;">
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:12px;">
          ...
          <label style="display:flex; align-items:center; gap:6px; font-size:12px; cursor:pointer; user-select:none;">
            <input type="checkbox" id="export-check-all-timdis" checked onchange="toggleAllExportFieldsTimdis(this)">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(180px, 1fr)); gap: 12px; background:var(--bg-lighter); padding:16px; border:1px solid var(--border); border-radius:8px;">
          <label style="display:flex; align-items:center; gap:8px; font-size:12px; cursor:pointer; user-select:none;">
            <input type="checkbox" class="export-field-cb-timdis" name="export_fields[]" value="id" checked>
            <span>ID / No. Pendaftaran</span>
          </label>
          <label style="display:flex; align-items:center; gap:8px; font-size:12px; cursor:pointer; user-select:none;">
            <input type="checkbox" class="export-field-cb-timdis" name="export_fields[]" value="name" checked>
            <span>Nama Mahasiswa</span>
          </label>
          <label style="display:flex; align-items:center; gap:8px; font-size:12px; cursor:pointer; user-select:none;">
            <input type="checkbox" class="export-field-cb-timdis" name="export_fields[]" value="email" checked>
            <span>Email Mahasiswa</span>
          </label>
          <label style="display:flex; align-items:center; gap:8px; font-size:12px; cursor:pointer; user-select:none;">
            <input type="checkbox" class="export-field-cb-timdis" name="export_fields[]" value="kompi" checked>
            <span>Kompi</span>
          </label>
          <label style="display:flex; align-items:center; gap:8px; font-size:12px; cursor:pointer; user-select:none;">
            <input type="checkbox" class="export-field-cb-timdis" name="export_fields[]" value="jurusan" checked>
            <span>Jurusan</span>
          </label>
          <label style="display:flex; align-items:center; gap:8px; font-size:12px; cursor:pointer; user-select:none;">
            <input type="checkbox" class="export-field-cb-timdis" name="export_fields[]" value="prodi" checked>
            <span>Prodi</span>
          </label>
          <label style="display:flex; align-items:center; gap:8px; font-size:12px; cursor:pointer; user-select:none;">
            <input type="checkbox" class="export-field-cb-timdis" name="export_fields[]" value="date" checked>
            <span>Tanggal Absensi</span>
          </label>
          <label style="display:flex; align-items:center; gap:8px; font-size:12px; cursor:pointer; user-select:none;">
            <input type="checkbox" class="export-field-cb-timdis" name="export_fields[]" value="check_in" checked>
            <span>Waktu Masuk</span>
          </label>
          <label style="display:flex; align-items:center; gap:8px; font-size:12px; cursor:pointer; user-select:none;">
            <input type="checkbox" class="export-field-cb-timdis" name="export_fields[]" value="check_out" checked>
            <span>Waktu Keluar</span>
          </label>
          <label style="display:flex; align-items:center; gap:8px; font-size:12px; cursor:pointer; user-select:none;">
            <input type="checkbox" class="export-field-cb-timdis" name="export_fields[]" value="status" checked>
            <span>Status Absensi</span>
          </label>
          <label style="display:flex; align-items:center; gap:8px; font-size:12px; cursor:pointer; user-select:none;">
            <input type="checkbox" class="export-field-cb-timdis" name="export_fields[]" value="camera_id" checked>
...
<script>
function toggleAllExportFieldsTimdis(source) {
  const checkboxes = document.querySelectorAll('.export-field-cb-timdis');
