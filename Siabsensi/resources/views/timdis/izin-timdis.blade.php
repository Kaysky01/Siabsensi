...
<section>
  ...
  <div class="panel" style="margin-bottom:16px;padding:14px 20px">
    <form method="GET" action="{{ route('timdis.izin-timdis') }}" style="display:flex;gap:8px;align-items:center">
        ...
        <tr>
          ...
          <td>
            ...
            <div style="display:flex;gap:4px">
              ...
              @endif
              <form method="POST" action="{{ route('timdis.izin.verify') }}">@csrf
              ...
              <form method="POST" action="{{ route('timdis.izin.verify') }}" onsubmit="var r=prompt('Alasan penolakan:');if(!r)return false;this.querySelector('[name=rejection_reason]').value=r;">@csrf
                <input type="hidden" name="submission_id" value="{{ $s->id }}">
