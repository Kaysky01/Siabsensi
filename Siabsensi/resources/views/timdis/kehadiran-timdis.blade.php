        ...
        <tr>
          ...
          <td>
            ...
            <div style="display:flex;gap:4px">
              ...
              @endif
              <form method="POST" action="{{ route('timdis.kehadiran.verify') }}">@csrf
              ...
              <form method="POST" action="{{ route('timdis.kehadiran.verify') }}" onsubmit="var r=prompt('Alasan penolakan:');if(!r)return false;this.querySelector('[name=reject_reason]').value=r;">@csrf
