...
<section>
  <div class="page-header">
    ...
    <div style="display:flex;gap:8px">
      <a href="{{ route('timdis.absensi-persesi') }}" class="btn btn-ghost btn-sm">
  ...
  <div class="panel" style="margin-bottom:16px">
    <div style="display:flex;gap:12px;flex-wrap:wrap;align-items:center">
      <form method="GET" action="{{ route('timdis.monitoring-sesi', $sesi->id) }}" style="display:flex;gap:12px;flex-wrap:wrap;align-items:center;width:100%">
      ...
      <a href="{{ route('timdis.monitoring-sesi', $sesi->id) }}" class="btn btn-ghost btn-sm">
